...
public class Huffman {
  ...
  // Utilizzo:
  // java -classpath "huffman_toolkit.jar:." Huffman compress <documento
  // originale> <documento compresso>
  // java -classpath "huffman_toolkit.jar:." Huffman decompress <documento
  // compresso> <documento ripristinato>
