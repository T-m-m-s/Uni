  ...
  \section{Specifica dei Requisiti}
    ...
    \subsection{Linguaggi per la Specifica}
      ...
      \subsubsection{Specifiche strutturate in template}
        \begin{figure}[htpb]
            \centering
            \includegraphics[width=0.6\linewidth]{figures/spec_tab.png}
        \end{figure}
    ...
    \subsection{Documento di Specifica Requisiti di Sistema (SRS)}
      ...
      \subsubsection{Utilizzatori}
        Molteplici tipologie di utenti utilizzano l'SRS per diversi scopi: informazioni contenute dipendono dal tipo di sistema e dall'approccio di sviluppo. Varietà di utenti comporta un compromesso sul livello di dettaglio da adottare
        \begin{figure}[h!]
          \begin{center}
            \includegraphics[width=0.5\textwidth]{figures/srs_usr.png}
          \end{center}
        \end{figure}
