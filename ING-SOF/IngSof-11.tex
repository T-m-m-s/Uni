  ...
  \section{Notazioni}
    ...
    \subsection{Fork / Join}
      \begin{itemize}
          ...
          \begin{figure}[htpb]
              \centering
              \includegraphics[width=0.8\linewidth]{figures/fl_fo_jo.png}
          \end{figure}
      \end{itemize}
\end{document}
