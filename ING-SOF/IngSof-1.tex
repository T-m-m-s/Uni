...
\begin{document}
  ...
  \section{Modello a Cascata (Waterfall)}
    ...
    \begin{figure}[h!]
      \begin{center}
        \includegraphics[width=0.5\textwidth]{figures/mod_cascata.png}
      \end{center}
    \end{figure}
    ...
    \begin{figure}[h!]
      \begin{center}
        \includegraphics[width=0.5\textwidth]{figures/mod_v.png}
      \end{center}
    \end{figure}
  \section{Modelli Evolutivi - Sviluppo Incrementale}
    ...
    \begin{figure}[h!]
      \begin{center}
        \includegraphics[width=0.5\textwidth]{figures/mod_sv_in.png}
      \end{center}
    \end{figure}
  \section{Modelli Evolutivi - Consegna Incrementale}
    ...
    \begin{figure}[h!]
      \begin{center}
        \includegraphics[width=0.5\textwidth]{figures/mod_co_in.png}
      \end{center}
    \end{figure}
  ...
  \section{Modelli Evolutivi - Prototipale}
    ...
    \begin{figure}[h!]
      \begin{center}
        \includegraphics[width=0.5\textwidth]{figures/mod_pr.png}
      \end{center}
    \end{figure}

    \subsection{Modello Prototipale - Back-To-Back Testing}
      \noindent % <--- Add this to ensure the first minipage isn't indented
      ...
      \begin{minipage}{0.38\textwidth}
        \centering % Use this instead of \begin{center} to save vertical space
        \includegraphics[height=5cm, keepaspectratio]{figures/mod_pr_b2b.png}
      \end{minipage}
  \section{Modello Orientato al Riuso}
    ...
    \begin{figure}[h!]
      \begin{center}
        \includegraphics[width=0.5\textwidth]{figures/mod_riu.png}
      \end{center}
    \end{figure}

  \section{Modello Trasformazionale}
    Idea: specifiche definite mediante linguaggi formali (spec. algebriche / modelli di stato), utilizzo di tecniche di model checking per provare correttezza. Specifiche formali venfono trasformate automaticamente in codice (correttezza preservata / verifica ottenuta implicitamente)
    \begin{minipage}{0.48\textwidth}
      \begin{itemize}
        \item Requisiti specificati formalmente in fase di analisi (specifiche verificate automaticamente prima di essere trasformate da opportuni strumenti);
        \item Descrizione formale trasformata man mano in una meno astratta / più dettagliata (manualmente o mediante appositi strumenti);
        \item Processo di trasformazione può trarre vantaggio da componenti riusabili. 
      \end{itemize}
    \end{minipage}
    \begin{minipage}{0.48\textwidth}
      Inserisci immagine
    ...
    \textbf{Problemi}
    \begin{itemize}
      \item Necessarie competenze in linguaggi formali;
      \item Alcune parti del sistema difficili da specificare formalmente;
      \item Difficoltà del cliente nel convalidare i requisiti. 
    \end{itemize}
    \textbf{Applicabilità}
    \begin{itemize}
      \item Non adatto per sistemi di grandi dimensioni;
      \item Utilizzato per parti critiche (dimostrazione validità \textit{by construction}).
    \end{itemize}
    \begin{figure}[h!]
      \begin{center}
        \includegraphics[width=0.5\textwidth]{figures/mod_tra.png}
      \end{center}
    \end{figure}
