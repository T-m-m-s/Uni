// ==========================================================
// DIY STREAM DECK LITE - 45° CONSOLE (SOLID FUSED CORNER BOSSES)
// - Corner screw posts solidly fused to walls and ceiling (No floating gaps!)
// - Calibrated 9mm M3 screw hole depth
// - 3.2" Screen + 6 Kailh Choc Keys + 2 Rotary Knobs
...
// --- Narrowed & Compact Dimensions ---
tilt_angle   = 45.0;// Steep 45° console angle
case_width   = 152; // Narrowed width (mm) - brings keys snug against screen!
...
disp_chin_offset = 3.5; // Horizontal chin compensation
...
// ==========================================================
// 1. SLIM TOP SHELL (Solid Corner Bosses Fused to Walls)
// ==========================================================
module top_shell() {
...
// ==========================================================
// 2. BOTTOM BASE PLATE (With 0.5cm U-Notch on Lower Part Only)
// ==========================================================
module bottom_plate() {
    plate_thick = 2.0;
    lip_thick   = 1.5;
